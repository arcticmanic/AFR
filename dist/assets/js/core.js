(function (factory) {
  typeof define === 'function' && define.amd ? define('core', factory) :
  factory();
}((function () { 'use strict';
  ...
  */
  ...
  var MicroModal = function () {
    ...
    var Modal = /*#__PURE__*/function () {
      function Modal(_ref) {
        ...
        _classCallCheck$1(this, Modal); // Save a reference of the modal
  ...
  const hasStatusAfterLoading = element => statusesAfterLoading.indexOf(getStatus(element)) > -1;
  ...
  const shouldUseNative = settings => settings.use_native && loadingString in HTMLImageElement.prototype;
  ...
  const intersectionHandler = (entries, settings, instance) => {
    entries.forEach(entry => isIntersecting(entry) ? onIntersecting(entry.target, entry, settings, instance) : onNotIntersecting(entry.target, entry, settings, instance));
  };
